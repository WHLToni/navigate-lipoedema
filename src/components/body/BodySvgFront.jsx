...
export default function BodySvgFront({ regionData = {}, onRegionTap, selectedRegion }) {
  ...
  return (
    ...
    >
      ...
      {/* Abdomen */}
      <rect style={regionStyle("abdomen")} x="34" y="61" width="35" height="41" rx="2" onClick={() => handleTap("abdomen")} />
      {/* Left Hip */}
      ...
      {/* Left Knee */}
      <rect style={regionStyle("left-knee")} x="36" y="170" width="14" height="26" rx="2" onClick={() => handleTap("left-knee")} />
      {/* Right Knee */}
      <rect style={regionStyle("right-knee")} x="53" y="170" width="14" height="26" rx="2" onClick={() => handleTap("right-knee")} />
      {/* Left Calf */}
      <rect style={regionStyle("left-calf")} x="36" y="196" width="14" height="31" rx="2" onClick={() => handleTap("left-calf")} />
      {/* Right Calf */}
      <rect style={regionStyle("right-calf")} x="53" y="196" width="14" height="31" rx="2" onClick={() => handleTap("right-calf")} />
      {/* Left Ankle */}
      <rect style={regionStyle("left-ankle")} x="36" y="227" width="14" height="29" rx="2" onClick={() => handleTap("left-ankle")} />
      {/* Right Ankle */}
      <rect style={regionStyle("right-ankle")} x="53" y="227" width="14" height="29" rx="2" onClick={() => handleTap("right-ankle")} />
