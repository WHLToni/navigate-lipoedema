...
export default function BodySvgFront({ regionData = {}, onRegionTap, selectedRegion }) {
  ...
  return (
    ...
    >
      ...
      {/* Right Hip y:78-113 */}
      <rect style={regionStyle("right-hip")} x="63" y="78" width="26" height="34" rx="2" onClick={() => handleTap("right-hip")} />
      {/* Left Upper Thigh y:113-170 */}
      <rect style={regionStyle("left-upper-thigh")} x="16" y="113" width="20" height="57" rx="2" onClick={() => handleTap("left-upper-thigh")} />
      {/* Right Upper Thigh y:113-170 */}
      <rect style={regionStyle("right-upper-thigh")} x="67" y="113" width="20" height="57" rx="2" onClick={() => handleTap("right-upper-thigh")} />
      {/* Left Inner Thigh y:113-170 */}
      <rect style={regionStyle("left-inner-thigh")} x="36" y="113" width="14" height="57" rx="2" onClick={() => handleTap("left-inner-thigh")} />
      {/* Right Inner Thigh y:113-170 */}
      <rect style={regionStyle("right-inner-thigh")} x="53" y="113" width="14" height="57" rx="2" onClick={() => handleTap("right-inner-thigh")} />
      {/* Left Knee y:170-196 */}
      <rect style={regionStyle("left-knee")} x="17" y="170" width="19" height="26" rx="2" onClick={() => handleTap("left-knee")} />
      {/* Right Knee y:170-196 */}
      <rect style={regionStyle("right-knee")} x="67" y="170" width="19" height="26" rx="2" onClick={() => handleTap("right-knee")} />
      {/* Left Calf y:196-227 */}
      <rect style={regionStyle("left-calf")} x="18" y="196" width="17" height="31" rx="2" onClick={() => handleTap("left-calf")} />
      {/* Right Calf y:196-227 */}
      <rect style={regionStyle("right-calf")} x="68" y="196" width="17" height="31" rx="2" onClick={() => handleTap("right-calf")} />
      {/* Left Ankle y:227-256 */}
      <rect style={regionStyle("left-ankle")} x="19" y="227" width="15" height="29" rx="2" onClick={() => handleTap("left-ankle")} />
      {/* Right Ankle y:227-256 */}
      <rect style={regionStyle("right-ankle")} x="69" y="227" width="15" height="29" rx="2" onClick={() => handleTap("right-ankle")} />

      {/* Arms — unchanged, already correct */}
