          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="space-y-5">
            ...
            <div className="bg-card rounded-2xl p-5 border border-border shadow-sm">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-base text-pakistani-green" style={{ fontFamily: "var(--font-heading)", fontWeight: 800 }}>Morning Sunlight</h3>
            ...
            {/* Quick Tissue Scan */}
            <div className="bg-card rounded-2xl p-5 border border-border shadow-sm">
              <h3 className="text-base text-pakistani-green mb-1" style={{ fontFamily: "var(--font-heading)", fontWeight: 800 }}>
                Quick Tissue Scan
              </h3>
              <p className="text-xs text-muted-foreground mb-4">Slide each region: Cold ← Neutral → Warm</p>
                    ...
                    return (
                      <div key={rid}>
                        <div className="flex items-center justify-between mb-1">
                          ...
                          <span className="text-xs text-muted-foreground">{val <= 3 ? "Cold" : val >= 7 ? "Warm" : "Neutral"}</span>
                        </div>
                        <Slider
                          value={[val]}
              ...
              <Button
                ...
                className="mx-auto mt-5 h-12 text-white font-medium flex"
          ...
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="space-y-4">
            ...
            <div className="bg-tea-green rounded-2xl p-6 border-2 border-pakistani-green">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-lg text-pakistani-green" style={{ fontFamily: "var(--font-heading)", fontWeight: 800 }}>
            ...
            <div className="grid grid-cols-2 gap-3">
              <QuickActionCard icon={<Moon className="w-5 h-5" />} label="Evening Reflection" bgColor="bg-shampoo" href="/habits" />
              <QuickActionCard icon="🗺️" label="Pain Map" bgColor="bg-misty-rose" href="/body-map" />
            </div>

            {/* Profile Summary */}
            <div className="bg-card rounded-2xl p-5 border border-border">
              <h3 className="text-base text-pakistani-green mb-1" style={{ fontFamily: "var(--font-heading)", fontWeight: 800 }}>Your Profile</h3>
              <div className="brand-rule" />
...
function QuickActionCard({ icon, label, bgColor, href }) {
  return (
    <a href={href} className={`${bgColor} rounded-2xl p-4 flex flex-col items-center gap-2 transition-transform hover:scale-105`}>
